...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    location: 'Remote / Gütersloh, Germany',
  ...
  },
  {
    ...
    description:
      "Embedded a dynamic price estimator into a pipe manufacturer's existing website, letting customers get instant order estimates through a guided questionnaire — reducing friction in the inquiry process.",
    technologies: ['TypeScript', 'React', 'Tailwind', 'Docker'],
    location: 'Remote',
    fromDate: new Date(2023, 3),
    toDate: new Date(2024, 0)
  },
  {
    ...
    location: 'Remote',
    fromDate: new Date(2022, 8),
    toDate: new Date(2023, 0)
  },
  {
  ...
  },
  {
    ...
    location: 'Remote',
    fromDate: new Date(2021, 2),
    toDate: new Date(2021, 10)
  },
  {
    ...
    fromDate: new Date(2020, 9),
    toDate: new Date(2021, 0)
  },
  {
    title: 'Social Distancing Compliance Application Using Camera Technology',
    description:
      'Built a camera-based social distancing monitor at the height of the COVID-19 pandemic. Uses perspective correction and environmental calibration to accurately measure real-world distances between people — no cloud required, with API alerts when thresholds are breached.',
  ...
  },
  {
    ...
    location: 'Remote',
    fromDate: new Date(2020, 4),
    toDate: new Date(2020, 6)
  }
]
